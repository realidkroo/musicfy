...
import com.example.musicfy.constants.MiniPlayerBackgroundStyleKey
import com.example.musicfy.constants.MiniPlayerHeight
import com.example.musicfy.constants.PlayerBackgroundStyle
import com.example.musicfy.constants.PureBlackMiniPlayerKey
...
import com.example.musicfy.core.isBluetoothHeadphoneConnected
    ...
    Box(
        ...
        Box(
            modifier = Modifier
                ...
                .let { if (isTransparent) it else it.background(color = backgroundColor).border(1.dp, outlineColor.copy(alpha = 0.3f), RoundedCornerShape(32.dp)) }
        ) {
            // Background Layers
            if (!isTransparent) {
