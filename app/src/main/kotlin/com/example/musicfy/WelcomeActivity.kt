...
fun WelcomePagerScreen(onFinished: () -> Unit) {
    ...
    val customWelcomeFontFamily = FontFamily(
        Font(
            resId = com.example.musicfy.R.font.sans_flex,
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = stringResource(com.example.musicfy.R.string.welcome_to),
                        style = thinHeaderStyle,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                    Text(
                        text = stringResource(com.example.musicfy.R.string.app_name),
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(com.example.musicfy.R.string.welcome_preparing_subtitle),
                            fontFamily = InterFontFamily,
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = stringResource(com.example.musicfy.R.string.perm_required),
                        style = thinHeaderStyle,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                    Text(
                        text = stringResource(com.example.musicfy.R.string.perm_permissions),
                        fontFamily = InterFontFamily,
                        fontWeight = FontWeight.Bold,
                        fontSize = 48.sp,
                        color = MaterialTheme.colorScheme.primary,
                    ...
                    Text(
                        text = stringResource(com.example.musicfy.R.string.perm_intro_text),
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            title = stringResource(com.example.musicfy.R.string.perm_notif_title),
                            description = stringResource(com.example.musicfy.R.string.perm_notif_desc),
                        ...
                        if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                            ...
                            PermissionCard(
                                ...
                                title = stringResource(com.example.musicfy.R.string.perm_install_title),
                                description = stringResource(com.example.musicfy.R.string.perm_install_desc),
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = "Musicfy is open-source and depends on community support to grow. Your help makes a difference!",
                        style = MaterialTheme.typography.bodyLarge.copy(
                            fontFamily = InterFontFamily
                        ),
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://github.com/musicfy-app/musicfy")
                            }
                        )
                        ...
                        PermissionCard(
                            icon = painterResource(com.example.musicfy.R.drawable.telegram),
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://t.me/musicfyapp")
                            }
                        )
            ...
            content = { onUpdateScroll ->
                Column(
                    ...
                    Column(modifier = Modifier.padding(bottom = 16.dp)) {
                        Text(
                            text = stringResource(com.example.musicfy.R.string.feat_discover),
                            style = thinHeaderStyle,
                            color = MaterialTheme.colorScheme.onBackground
                        )
                        Text(
                            text = stringResource(com.example.musicfy.R.string.feat_features),
                            fontFamily = InterFontFamily,
                            fontWeight = FontWeight.Bold,
                            fontSize = 48.sp,
                            color = MaterialTheme.colorScheme.primary,
                        ...
                        Text(
                            text = stringResource(com.example.musicfy.R.string.feat_intro),
                            style = MaterialTheme.typography.bodyLarge.copy(
                                fontFamily = InterFontFamily
                            ),
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Box(modifier = Modifier.weight(1f)) {
                        ...
                        Column(
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffaee4),
                                iconTint = Color(0xFF8d0053),
                                title = stringResource(com.example.musicfy.R.string.feat_lyrics_title),
                                description = stringResource(com.example.musicfy.R.string.feat_lyrics_desc),
                                shape = topCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                shape = middleCardShape,
                                title = stringResource(com.example.musicfy.R.string.feat_download_title),
                                description = stringResource(com.example.musicfy.R.string.feat_download_desc)
                            )
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffb683),
                                iconTint = Color(0xFF753403),
                                title = stringResource(com.example.musicfy.R.string.feat_quality_title),
                                description = stringResource(com.example.musicfy.R.string.feat_quality_desc),
                                shape = middleCardShape
                            )
                            ...
                            if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                                ...
                                FeatureCard(
                                    ...
                                    iconColor = Color(0xFF67d4ff),
                                    iconTint = Color(0xFF004e5d),
                                    title = stringResource(com.example.musicfy.R.string.feat_update_title),
                                    description = stringResource(com.example.musicfy.R.string.feat_update_desc),
                                    shape = middleCardShape
                                )
                            }
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.example.musicfy.R.string.feat_license_title),
                                description = stringResource(com.example.musicfy.R.string.feat_license_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.example.musicfy.R.string.feat_github_title),
                                description = stringResource(com.example.musicfy.R.string.feat_github_desc),
                                shape = bottomCardShape
                            )
            ...
            Row(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = stringResource(com.example.musicfy.R.string.back_button_desc),
                        onClick = {
                            if (!isFirstPage) {
                                scope.launch {
                                    pagerState.animateScrollToPage(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = if (isLastPage) stringResource(com.example.musicfy.R.string.get_started) else stringResource(
                            com.example.musicfy.R.string.next
                        ),
                        onClick = {
                            if (isLastPage) {
...
fun RotatingShapeContainer(modifier: Modifier = Modifier) {
    ...
    Box(
        ...
        Icon(
            painter = painterResource(id = com.example.musicfy.R.drawable.ic_ten_sided_cookie),
            contentDescription = null,
            tint = primaryColor,
            modifier = Modifier
                .fillMaxSize()
        ...
        Icon(
            painter = painterResource(com.example.musicfy.R.mipmap.ic_launcher_monochrome),
            contentDescription = null,
